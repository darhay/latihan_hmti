...
Future<List<Map<String, String>>> fetchNews() async {
  final response = await http.get(Uri.parse('https://hmti-news.hppms-sabala.my.id/api/posts'));
  ...
  if (response.statusCode == 200) {
    try {
      ...
      return data.map<Map<String, String>>((item) {
        ...
        return {
          'imageUrl': 'https://hmti-news.hppms-sabala.my.id/public_storage/' + (item['image'] ?? ''),
